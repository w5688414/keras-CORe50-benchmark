...
def list_pictures(directories, ext='jpg|jpeg|bmp|png'):
    return [os.path.join(root, f)
            for root, _, files in os.walk(directory) for directory in directories for f in files
...
def _list_valid_filenames_in_directory(directories, white_list_formats,
...
class DirectoryIterator(Iterator):
    ...
    def __init__(self, directories, image_data_generator,
        ...
        i = 0
        for dirpath in (os.path.join(directory, subdir)  for directory in directories for subdir in classes):
